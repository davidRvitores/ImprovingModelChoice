...
title(paste(" Loglik =", round(iris2CPCb$loglik,4), "\n df = ",iris2CPCb$df, "\n BIC=",round(iris2CPCb$BIC,4)),line=-7,outer=T)
...
grafElipsesError(X,iris2PROPb$posterior,iris2PROP$par,d=4,0,labels)
title(paste(" Loglik =", round(iris2PROPb$loglik,4), "\n df = ",iris2PROPb$df, "\n BIC=",round(iris2PROPb$BIC,4)),line=-7,outer=T)
error(labels, apply(iris2PROP$posterior,1,which.max))
...
title(paste(" Loglik =", round(crabs2CPC$loglik,4), "\n df = ",crabs2CPC$df, "\n BIC=",round(crabs2CPC$BIC,4)),line=-7,outer=T)
...
title(paste(" Loglik =", round(crabs2PROP$loglik,4), "\n df = ",crabs2PROP$df, "\n BIC=",round(crabs2PROP$BIC,4)),line=-7,outer=T)
...
# THIS EXAMPLE NEEDS A LOT OF RANDOM INITIALIZATIONS, EXPENSIVE COMPUTATIONAL TIMES.
...
title(paste(" Loglik =", round(oliveoil2CPC$loglik,4), "\n df = ",oliveoil2CPC$df, "\n BIC=",round(oliveoil2CPC$BIC,4)),line=-7,outer=T)
...
title(paste(" Loglik =", round(oliveoil3CPC$loglik,4), "\n df = ",oliveoil3CPC$df, "\n BIC=",round(oliveoil3CPC$BIC,4)),line=-7,outer=T)
cat("Region separation = ", c(rep("S",4),rep("I",2),rep("N",3)), "\t (S=south, I=Island of Sardinia, N=Centre-North)\n",
...
title(paste(" Loglik =", round(oliveoil3PROP$loglik,4), "\n df = ",oliveoil3PROP$df, "\n BIC=",round(oliveoil3PROP$BIC,4)),line=-7,outer=T)
cat("Region separation = ", c(rep("S",4),rep("I",2),rep("N",3)), "\t (S=south, I=Island of Sardinia, N=Centre-North)\n",
...
cancer3CPC <- GCPC(X,k=5,M=3,csh=1000,cvol=1000,niter=100,tol=10^(-5),nstart=30,graph=F)
grafElipsesError(X,cancer3CPC$posterior,cancer3CPC$par,d=8,0,labels)
title(paste(" Loglik =", round(cancer3CPC$loglik,4), "\n df = ",cancer3CPC$df, "\n BIC=",round(cancer3CPC$BIC,4)),line=-7,outer=T)
